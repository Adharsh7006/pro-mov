 ...
 console.log(sample);
  ...
  return (
    first.map((aus)=>
      ...
      <div>
        <Link to={`/Moviedetail/${aus.id}`}>
        <Card style={{ float:'left',width: '17.5rem',height:'550px',marginLeft:'35px',marginTop:'20px'}}>
      ...
      <Card.Body>
        ...
        <Button style={{marginTop:'20px'}} variant="primary">Go somewhere</Button>
      </Card.Body>
    </Card>
    </Link>
    </div>
